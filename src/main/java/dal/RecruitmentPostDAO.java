...
public class RecruitmentPostDAO extends DBContext { // Kế thừa DBContext để dùng getConnection
    ...
    public List<RecruitmentPost> getUploadedPosts() {
        ...
        String sql = "SELECT "
                ...
                + "WHERE (rp.status = 'Approved' OR rp.status = 'Uploaded') "
    ...
    public boolean updatePost(int postId, String title, String content, String depId) {
        String sql = "UPDATE RecruitmentPost SET title = ?, content = ?, dep_id = ?, status = 'New', updated_at = ? "
    ...
    public boolean sendPost(int postId) {
        String sql = "UPDATE RecruitmentPost SET status = 'Waiting', updated_at = ? "
    ...
    public boolean approvePost(int postId, int approvedBy, String note) {
        String sql = "UPDATE RecruitmentPost SET status = 'Approved', approved_by = ?, approved_at = ?, updated_at = ? " +
    ...
    public List<RecruitmentPost> getApprovedUploadedDeletedPosts() {
        List<RecruitmentPost> posts = new ArrayList<>();
        String sql = "SELECT "
                + "rp.post_id, "
                + "rp.title, "
                ...
                + "LEFT JOIN Employee e1 ON rp.created_by = e1.emp_id "
                + "LEFT JOIN Employee e2 ON rp.approved_by = e2.emp_id "
                + "WHERE (rp.status = 'Approved' OR rp.status = 'Uploaded' OR rp.status = 'Deleted') "
                + "ORDER BY rp.approved_at DESC";
        ...
        try (Connection conn = DBContext.getConnection();
            ...
            System.err.println("Error getting approved, uploaded and deleted recruitment posts: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public boolean uploadPost(int postId) {
        String sql = "UPDATE RecruitmentPost SET status = 'Uploaded', updated_at = ? "
        ...
        try (Connection conn = DBContext.getConnection();
            ...
            System.err.println("Error uploading recruitment post: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
    ...
    public boolean deletePost(int postId) {
        String sql = "UPDATE RecruitmentPost SET status = 'Deleted', updated_at = ? "
                + "WHERE post_id = ? AND status = 'Approved'";
    ...
    public boolean takeDownPost(int postId) {
        String sql = "UPDATE RecruitmentPost SET status = 'Approved', updated_at = ? "
                + "WHERE post_id = ? AND status = 'Uploaded'";
        ...
        try (Connection conn = DBContext.getConnection();
            ...
            System.err.println("Error taking down recruitment post: " + e.getMessage());
            e.printStackTrace();
            return false;
        }
    }
