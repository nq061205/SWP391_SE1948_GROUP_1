    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (emp == null) {
                ...
                String passwordGenerate = generatePassword();
                util.sendEmail(email, "Request to reset password", passwordGenerate);
                lDao.updatePassword(emp.getEmpCode(), passwordGenerate);
