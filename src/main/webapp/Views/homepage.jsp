                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="service-bx">
                                        ...
                                        <div class="info-bx text-center">
                                            ...
                                            <h4><a href="javascript:;">Friendly Environment</a></h4>
                                            <a href="javascript:;" class="btn radius-xl">View More</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="service-bx m-b0">
                                        ...
                                        <div class="info-bx text-center">
                                            ...
                                            <h4><a href="javascript:;">Innovative Thinking</a></h4>
                                            <a href="javascript:;" class="btn radius-xl">View More</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12 heading-bx left">
                                    <h2 class="title-head">Highlighted <span> Projects</span></h2>
                                    <p>Here you can explore our highlighted projects that represent our capabilities and trusted partnerships.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                                    <div class="item">
                                        <div class="cours-bx">
                                            ...
                                            <div class="info-bx text-center">
                                                <h5><a href="#">VisionX Platform</a></h5>
                                            </div>
                                            <div class="cours-more-info">
                                                <div class="review">
                                                    <span>99,999 Reviews</span>
                                                    <ul class="cours-star">
                                    ...
                                    <div class="item">
                                        <div class="cours-bx">
                                            ...
                                            <div class="info-bx text-center">
                                                <h5><a href="#">MediConnect System</a></h5>
                                            </div>
                                            <div class="cours-more-info">
                                                <div class="review">
                                                    <span>53,123 Reviews</span>
                                                    <ul class="cours-star">
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                    ...
                                    <div class="item">
                                        <div class="cours-bx">
                                            ...
                                            <div class="info-bx text-center">
                                                <h5><a href="#">SmartRetail Hub</a></h5>
                                            </div>
                                            <div class="cours-more-info">
                                                <div class="review">
                                                    <span>30,888 Reviews</span>
                                                    <ul class="cours-star">
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                    ...
                                    <div class="item">
                                        <div class="cours-bx">
                                            ...
                                            <div class="info-bx text-center">
                                                <h5><a href="#">SafeNet Security</a></h5>
                                            </div>
                                            <div class="cours-more-info">
                                                <div class="review">
                                                    <span>15,237 Reviews</span>
                                                    <ul class="cours-star">
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                                        <li class="active"><i class="fa fa-star"></i></li>
                                                        <li class="active"><i class="fa fa-star"></i></li>
