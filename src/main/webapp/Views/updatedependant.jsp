        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">Dependant information</h4>
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="${pageContext.request.contextPath}/updatedependant" method="POST">
                                    <input type="hidden" name="empId" value="${empId}">
                                    <div class="form-group row mt-2">
                                        <label class="col-sm-3 col-form-label">Dependant Name:</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="name" value="${sessionScope.dependant.name}" required>
                                        </div>
                                        ...
                                        <div class="col-sm-9">
                                            <select name="relationship">
                                                <c:forEach items="${relationList}" var="rl">
                                                    <option value="${rl}" ${sessionScope.dependant.relationship eq rl ? 'selected' : ''}>${rl}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="gender">
                                                <option value="Male" ${sessionScope.dependant.gender ? 'selected' : ''}>Male</option>
                                                <option value="Female" ${!sessionScope.dependant.gender ? 'selected' : ''}>Female</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" name="phone" type="text" value="${sessionScope.dependant.phone}" required>
                                            <p>${PhoneErr}</p>
                                        </div>
                                    ...
                                    <div class="form-group row mt-4">
                                        <div class="col-sm-9 offset-sm-3">
                                            <button type="button" class="btn btn-secondary"
                                                    onclick="window.location.href = '${pageContext.request.contextPath}/employeedetail?tab=Dependant&empId=${empId}'">
                                                ← Back
                                            </button>
