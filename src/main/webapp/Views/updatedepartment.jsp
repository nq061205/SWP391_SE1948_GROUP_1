                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="${pageContext.request.contextPath}/updatedepartment" method="POST">
                                    ...
                                    <div class="form-group row mt-4">
                                        <div class="col-sm-9 offset-sm-3">
                                            <button type="button" class="btn btn-secondary"
                                                    onclick="window.location.href = '${pageContext.request.contextPath}/departmentlist'">
                                                ← Back
                                            </button>
