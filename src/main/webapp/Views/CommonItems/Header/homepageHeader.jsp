        ...
        <div class="container">
            <div class="row d-flex justify-content-between">
                <div class="topbar-left">
                    <ul>
                        <li><a href="javascript:;"><i class="fa fa-question-circle"></i>FAQ</a></li>
    ...
    <div class="sticky-header navbar-expand-lg">
        <div class="menu-bar clearfix">
            <div class="container clearfix">
                <!-- Header Logo ==== -->
                <div class="menu-logo">
                    <a href="homepage"><img src="${pageContext.request.contextPath}/assets1/images/logo-white.png" alt=""></a>
                </div>
                <!-- Mobile Nav Button ==== -->
