            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="${pageContext.request.contextPath}/systemlogdetail" method="post" class="widget-box p-4 shadow-sm bg-white rounded" onsubmit="return confirmAction(this, 'update')">
...
<input type="hidden" name="note" value="">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${leave.leaveType == 'Sick Leave'}">
                                        <input type="text" class="form-control" value="Sick" disabled>
                                    </c:when>
                                    <c:when test="${leave.leaveType == 'Personal Reason'}">
                                    ...
                                    <c:when test="${leave.leaveType == 'Family Business leave'}">
                                        <input type="text" class="form-control" value="Other" disabled>
                                    </c:when>
                                </c:choose>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    min="<%= java.time.LocalDate.now().minusDays(7) %>"
                                ...
                                <p>
                                    ...
                                    <span style="font-weight: bold;
                                          ...
                                          <c:choose>
                                              ...
                                              <c:when test="${leave.status eq 'Pending'}">goldenrod</c:when>
                        ...
                        <a href="${pageContext.request.contextPath}/systemlog" class="btn btn-dark btn-sm">
                            <i class="fa fa-arrow-left"></i> Return to System Log
                        </a>
                        <form action="${pageContext.request.contextPath}/systemlogdetail" method="post" style="display:inline;" onsubmit="return confirmAction(this, 'invalid')">
                            <input type="hidden" name="action" value="Invalid">
                            <input type="hidden" name="id" value="${leave.leaveId}">
                            <input type="hidden" name="note" value="Invalid action">
                            <button type="submit" class="btn btn-danger btn-sm" title="Invalid">
