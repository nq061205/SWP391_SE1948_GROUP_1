                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="${pageContext.request.contextPath}/updateaccount" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" value="${sessionScope.emp.empCode}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" value="${sessionScope.emp.status ? 'Male' :'Female'}" readonly>
                                                </div>
                                            </div>
